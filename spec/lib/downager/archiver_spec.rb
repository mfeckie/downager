...
files_for_test = [["1.1.1", input_path + "1.1.1/sample_1.txt", "sample_1.txt"],
                  ["1.1.1", input_path + "1.1.1/sample_2.txt", "sample_2.txt"],
                  ["1.1.2", input_path + "1.1.2/sample_10.txt", "sample_10.txt"],
                  ["1.1.2", input_path + "1.1.2/sample_11.txt", "sample_11.txt"]]
